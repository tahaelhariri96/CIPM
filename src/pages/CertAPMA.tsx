        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "40px" }}>
          <div style={{ flex: 1, maxWidth: "798px" }}>
            ...
            <p style={{ ...fw300, fontSize: "18px", color: "#535453", lineHeight: 1.4, margin: 0 }}>
              The CIPM-APMA (Agile Project Management Advanced) is a senior-level credential designed for experienced Agile practitioners and leaders seeking to master enterprise-wide Agile adoption, organizational transformation, and strategic agile coaching. This program covers scaled Agile frameworks, enterprise portfolio management, and cultural change leadership required to drive large-scale agile initiatives. Whether leading agile transformation across your organization or coaching enterprise agile teams, the CIPM-APMA validates expertise in advancing agile strategy and organizational excellence.
            </p>
          </div>
          <InfoCard />
        </div>
    ...
    <div style={{ display: "flex", minHeight: "510px" }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
          <AudienceItem
            icon={<GradCapSvg />}
            title="Senior Agile Leaders"
            description="Experienced Agile practitioners and leaders seeking advanced organizational transformation and strategic agile coaching skills."
          />
          <AudienceItem
            icon={<LaptopSvg />}
            title="Enterprise Agile Coaches"
            description={`Professionals responsible for scaling Agile frameworks across large organizations and managing enterprise portfolio transformation.`}
          />
          <AudienceItem
            icon={<BriefcaseSvg />}
            title="Organizational Leaders"
            description="C-level executives and PMO directors driving large-scale agile adoption and cultural change initiatives."
          />
        </div>
      </div>
    </div>
...
function TopicsSection() {
  const topics = [
    { n: "1", t: "Scaled Agile frameworks and enterprise portfolio management." },
    { n: "2", t: "Organizational change management and cultural transformation." },
    { n: "3", t: "Strategic agile coaching and executive leadership alignment." },
    { n: "4", t: "Multi-team coordination and enterprise scaling patterns." },
    { n: "5", t: "Metrics, governance, and risk management at enterprise scale." },
  ];
          ...
          <div style={{ display: "flex", gap: "24px", alignItems: "center" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                ...
                <span style={{ ...fw600, fontSize: "18px", color: theme.bg, lineHeight: 1.2 }}>$400</span>
              </div>
            </div>
          </div>
          <button
