      ...
      <div style={{ ...innerContainer, position: "relative", paddingTop: "56px", paddingBottom: "100px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "48px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "20px", flexShrink: 0 }}>
            ...
            <div style={{ boxShadow: "0px 0px 30px 0px rgba(104,23,163,0.54)" }}>
              <img
                src={img02PmccBadgeLogo}
                alt="CIPM-PMCC Badge"
                style={{ width: "228px", height: "211px", objectFit: "contain", display: "block", background: "transparent", mixBlendMode: "multiply" }}
              />
            </div>
          </div>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <p style={{ ...fw400, fontSize: "24px", color: theme.headingColor, lineHeight: 1.2, margin: 0 }}>
                Take Your Project Management Career to the Next Level
              </p>
              <p style={{ ...fw300, fontSize: "18px", color: theme.primary, lineHeight: 1.4, margin: 0 }}>
                Build on existing knowledge and master core methodologies used by senior project managers.
              </p>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
              <span style={{ ...fw300, fontSize: "16px", color: theme.buttonBg, lineHeight: 1.4 }}>Total Fee</span>
              <span style={{ ...fw600, fontSize: "18px", color: theme.primary, lineHeight: 1.2 }}>$300</span>
              <button
                style={{
...
function InfoCard() {
  const rows = [
    ...
    { label: "Estimated Effort", value: "45 Hours", bg: "white", pt: "12px", pb: "12px" },
    { label: "Length", value: "110 Multiple Choice Questions.", bg: theme.bg, pt: "12px", pb: "16px" },
  ];
  return (
    <div
      style={{
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "40px" }}>
          <div style={{ flex: 1, maxWidth: "798px" }}>
            ...
            <p style={{ ...fw300, fontSize: "18px", color: "#535453", lineHeight: 1.4, margin: 0 }}>
              The CIPM-PMCC (Project Management Core Certificate) is designed for project management professionals with foundational experience seeking to deepen their expertise in core PM methodologies and practices. This credential bridges foundational and advanced knowledge, validating competence in managing mid-level complexity projects and leading smaller teams. The CIPM-PMCC is ideal for professionals advancing their careers or transitioning into dedicated project management roles.
            </p>
          </div>
          <InfoCard />
        </div>
    ...
    <div style={{ display: "flex", minHeight: "510px" }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
          <AudienceItem
            icon={<GradCapSvg />}
            title="Mid-Career Project Managers"
            description="Professionals with 2-3 years of hands-on project management experience looking to formalize and expand their core competencies."
          />
          <AudienceItem
            icon={<LaptopSvg />}
            title="Team Lead Professionals"
            description={`Those managing project teams and sub-projects who want to master core methodologies and best practices for greater impact.`}
          />
          <AudienceItem
            icon={<BriefcaseSvg />}
            title="Transitioning Professionals"
            description="Experts from other fields with foundational PM knowledge seeking to deepen expertise and earn an industry-recognized credential."
          />
        </div>
      </div>
    </div>
...
function TopicsSection() {
  const topics = [
    { n: "1", t: "Core project management frameworks and methodologies." },
    { n: "2", t: "Intermediate planning, scheduling, and resource management." },
    { n: "3", t: "Stakeholder management and team coordination." },
    { n: "4", t: "Risk and quality management fundamentals." },
    { n: "5", t: "Project execution and monitoring best practices." },
  ];
