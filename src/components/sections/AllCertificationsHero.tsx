...
function ArrowRight() {
  return (
    <svg style={{ width: '20px', height: '20px', overflow: 'hidden' }} width="20" height="20" viewBox="0 0 20 20" fill="none">
      <g clipPath="url(#clip0_allcerts_hero)">
      ...
      <defs>
        <clipPath id="clip0_allcerts_hero">
...
export default function AllCertificationsHero() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '267px', overflow: 'visible' }}>
      ...
      <div style={{ position: 'absolute', left: '246px', top: '143px', display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '24px', zIndex: 100 }}>
        <BackButton onClick={() => navigate('/')} />
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '4px' }}>
            <p style={{ color: 'rgba(255,255,255,1)', fontSize: '16px', fontWeight: 400, lineHeight: '140%', margin: 0 }}>Home</p>
            <ArrowRight />
          </div>
          <h1 style={{ color: 'rgba(255,255,255,1)', fontSize: '36px', fontWeight: 400, lineHeight: '120%', margin: 0, whiteSpace: 'nowrap' }}>All Certifications</h1>
        </div>
      </div>
    </div>
  );
