    ...
    <div style={{ position: 'relative', width: '100%', height: '267px', overflow: 'visible' }}>
      ...
      <div style={{ position: 'absolute', left: '246px', top: '143px', width: '340px', height: '73px', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', gap: '24px', zIndex: 100 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: '8px' }}>
          ...
          <h1 style={{ color: 'rgba(255, 255, 255, 1)', fontSize: '36px', fontWeight: '400', textAlign: 'left', lineHeight: '120.00000476837158%', margin: 0, whiteSpace: 'nowrap' }}>About Scrum Master</h1>
        </div>
      </div>
    </div>
  );
