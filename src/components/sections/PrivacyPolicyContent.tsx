    ...
    <main className="privacy-container">
      <section className="policy">
        ...
        <div className="policy__block">
          ...
          <p className="policy__text">IP address</p>
          <p className="policy__text">Browser type and device information</p>
          <p className="policy__text">Log data and usage analytics</p>
          <p className="policy__text">Cookies and tracking technologies</p>
        </div>
